...
impl Dictionary {
    ...
    ///
    /// The binary files must exist at `data/dict/{trie,metadata}.bin`,
    /// generated by running `thaime_dictgen`. This method is only available
    /// when the `embed-dict` feature is enabled (the default).
    #[cfg(feature = "embed-dict")]
    pub fn from_embedded() -> Self {
        static TRIE_BYTES: &[u8] = include_bytes!("../../../data/dict/trie.bin");
        static METADATA_BYTES: &[u8] = include_bytes!("../../../data/dict/metadata.bin");
